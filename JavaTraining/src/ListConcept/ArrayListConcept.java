...
public class ArrayListConcept {
	...
	public static void main(String[] args) {
		...
		ArrayList ar1=new ArrayList(); // This is a non-generic type because it has not been specified as to what all data-types can be stored in this array list.
	
		ArrayList<Integer> ar2=new ArrayList<Integer>(); //This is generic type as it has been specified that only integer data type values can be stored in this array list.
