...
public class ArrayConcept {
	...
	public static void main(String[] args) {
		...
		//2. Stores only similar data-types--> To overcome this limitation, we use object array
		...
		//6. Object array (Object is a class just like String. It can also be called as a superclass
